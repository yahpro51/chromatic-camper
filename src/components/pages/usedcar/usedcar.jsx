...
import { Usedcarcon,FDwrapper } from './style'
  ...
  <Datacon>
      <Datanavwrapp>
        <Datanav>
          <Datanavleft>
            <div>Item</div>
            <div style={{ color: "#006DAB" }}>{usedVehicles.length}</div>
          </Datanavleft>
          <Datanavright>
            <Datarightcon1>
