...
import { Tuningcon,FDwrapper } from './style'
import Footercomponent from '../motor/footer'

import Wallappercomponent from './wallpaper'
import { Card, Cardbtn, Carddown, Cardup, Cardwrapp, Datacon, Dataline, Datanav, Datanavleft, Datanavright, Datanavwrapp, Datarightcon1, Datarightcon2, DownPrice, Rightcon1input, Rightcon1text, Rightcon2input, Rightcon3input, Uptext,Comparebtn,
  Compareend,
  Comparemid,
  Comparetext,
  Filterbtns,
  ...
  <Datacon>
      <Datanavwrapp>
        <Datanav>
          <Datanavleft>
            <div>Item</div>
            <div style={{ color: "#006DAB" }}>{tuning.length}</div>
          </Datanavleft>
          <Datanavright>
            <Datarightcon1>
      ...
      <Cardwrapp>
        {
          tuning.map((value, index)=>{
            return(
              <Link to={`/tuningdetails/${value.id}`} style={{textDecoration: `none`}}><Card key={value}>
          <Cardup>
            <img src={car} alt="" />
            <Uptext>
          ...
          <Carddown>
            <DownPrice>{value.car.cost_krw}</DownPrice>
            <Cardbtn>
              <button>Order</button>
              <button>Compare</button>
            </Cardbtn>
